  ...
  return (
    <>
      <div>
        ...
        <button id="btnn" onClick={() => setState((value) => !value)}>
          Feedback
        </button>
      </div>
      <div className="containor">
        {set && (
          <form onSubmit={handleSubmit(onSubmit)} className="kol">
            <h1>Feedback Form </h1>
            <div>
              <lable className="rat">Rating</lable>
              <br />
              <input
                className="rating"
                type="number"
            ...
            <div>
              ...
              <input
                ...
                {...register('name', {
                  ...
                  minLength: {
                    value: 2,
                    message: 'must be greate then two number',
                  },
